...
async function main() {
  ...
  const shopkeeper = await prisma.user.upsert({
    ...
    update: {},
    create: { fullName: 'Ravi Kumar', mobileNumber: '9000000002', passwordHash, role: 'SHOPKEEPER' as any, districtId: district.id },
  });
  ...
  const citizen = await prisma.user.upsert({
    ...
    update: {},
    create: { fullName: 'Aarav Kumar', mobileNumber: '9000000001', passwordHash, role: 'CITIZEN' as any, districtId: district.id },
  });
