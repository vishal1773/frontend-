...
type Props = StackScreenProps<AuthStackParamList, 'ShopkeeperReports'>;
  ...
  return (
    <View style={styles.wrapper}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>Review transactions, beneficiary trends, and daily service summaries.</Text>
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Today’s report</Text>
          <Text style={styles.cardText}>{'Beneficiaries served: 48\nTransactions: 126\nRice distributed: 320 kg'}</Text>
        </View>
        <AppButton title="Back to Home" onPress={() => navigation.navigate('ShopkeeperDashboard')} />
      </ScrollView>
      <BottomNavigation active="reports" variant="shopkeeper" onTabPress={handleTabPress} />
    </View>
  );
}
