...
export default function ProfileScreen() {
  ...
  return (
    <ScreenContainer title="Profile" subtitle="State Admin account">
      <View style={styles.info}>
        <Text variant="titleMedium" style={styles.name}>{user?.name ?? 'State Admin'}</Text>
        <Text variant="bodyMedium" style={styles.meta}>Tamil Nadu Government</Text>
      </View>
